...
// Vladimir
#define qglVertex2i(x,y) qglVertex3f(x,y,0.0)
#define qglVertex2d(x,y) qglVertex3f(x,y,0.0)
#define qglVertex3i(x,y,z) qglVertex3f(x,y,0.0)
#define qglTexCoord2d qglTexCoord2f
#define qglTexCoord2i qglTexCoord2f
#define qglTexCoord3d qglTexCoord3f
#define qglVertex3d qglVertex3f
#define qglColor4ub(x,y,z,p) qglColor4f(x,y,z,p)
#define qglFogi qglFogf
#define qglRotated qglRotatef
#define qglTranslated qglTranslatef
#define qglScaled qglScalef
#define qglNormal3d qglNormal3f
#define qglColor4d qglColor4f
#define qglColor3d qglColor3f
#define qglMultMatrixd qglMultMatrixf
#define qglGetDoublev qglGetFloatv
#define qglLightModeli qglLightModelf
#define qglNormal3fv(v) qglNormal3f(v[0],v[1],v[2])
//
...
extern void ( * qglSelectTextureSGIS)( GLenum );
extern void ( * qglLockArraysEXT)( int, int);
extern void ( * qglUnlockArraysEXT) ( void );
extern void ( * qglPointParameterfEXT)( GLenum param, GLfloat value );
extern void ( * qglPointParameterfvEXT)( GLenum param, const GLfloat *value );
extern void ( * qglMTexCoord2fSGIS)( GLenum, GLfloat, GLfloat );
